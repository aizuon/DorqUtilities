...
DorqUtilities.RegisterAnimationStyle("Angled", InitAngled, "Alternate;Left;Right", "AngleUp;AngleDown")
DorqUtilities.RegisterAnimationStyle("Straight", InitStraight, "Up;Down", nil)
DorqUtilities.RegisterAnimationStyle("Parabola", InitParabola, "Up;Down", "CurvedLeft;CurvedRight")
DorqUtilities.RegisterAnimationStyle("Horizontal", InitHorizontal, "Alternate;Left;Right", "GrowUp;GrowDown")
DorqUtilities.RegisterAnimationStyle("Static", InitStatic, "Up;Down", nil)


-- Register the default sticky animation styles.
DorqUtilities.RegisterStickyAnimationStyle("Pow", InitPow, "Up;Down", "Normal;Jiggle")
DorqUtilities.RegisterStickyAnimationStyle("Static", InitStatic, "Up;Down", nil)
