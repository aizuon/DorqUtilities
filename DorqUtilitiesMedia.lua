...
local DEFAULT_SOUND_FILES = {
	["MSBT Low Health"]		= "Interface\\Addons\\DorqUtilities\\Sounds\\LowHealth.ogg",
	["MSBT Low Mana"]		= "Interface\\Addons\\DorqUtilities\\Sounds\\LowMana.ogg",
	["MSBT Cooldown"]		= "Interface\\Addons\\DorqUtilities\\Sounds\\Cooldown.ogg",
}
